...
class Header extends Component {
  ...
  render() {
    return (
      <header>
        <h1>PAUL AND KYLE'S <wbr />HORROR MOVIE LIST</h1>
        {(this.props.moviePageActive) ?
          <div className="headerBlurb">
            <h4>For every month for three years now, two best friends have gotten together to find a new horror-themed movie to review, with an eye for overlooked gems or overrated trash.</h4>
